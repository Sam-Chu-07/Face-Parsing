...
with open("./test.txt") as f:
    TA_test_list = f.read().splitlines() 
    TA_test_list = [int(i) for i in TA_test_list]
    print(f"### TA test list num: {len(TA_test_list)} ###")
...
for idx, x in enumerate(image_list.iloc[:, 1]):
    ...
    if idx in TA_test_list: # if x >= 162771 and x < 182638:
...
print('Training Num: ',train_count)
print('Testing Num: ',test_count)
print('Validation Num: ',val_count)
